    ...
    <header className="bg-[#ffffff] border-b border-[#e5e5e5] sticky top-0 z-[1100] shadow-sm backdrop-blur-md bg-opacity-95">
      <div className="max-w-[1600px] mx-auto px-3 sm:px-6">
        ...
        <div className="h-13 sm:h-14 flex items-center justify-between gap-2">
          ...
          {/* Live System Badge */}
          <div className="flex items-center gap-1.5 text-xs text-slate-700 font-medium bg-[#f4f4f4] px-2.5 py-1.5 sm:px-3 rounded-xl border border-[#e5e5e5] shrink-0">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse shrink-0" />
            <span className="text-[10px] sm:text-[11px] text-slate-800 font-semibold whitespace-nowrap">
              <span className="hidden sm:inline">Live </span>Heat Guardian
            </span>
          </div>
        </div>
