      ...
      <div className="card-surface p-3.5 flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-[#f4f4f4] border border-[#e5e5e5] text-[#141414] rounded-xl px-3 py-1.5 text-xs font-semibold focus:outline-none focus:border-slate-400 cursor-pointer"
            >
              {sites.map((s) => (
          ...
          {currentTempF !== null ? (
            <div className="flex items-center gap-2">
              <span className="text-xs text-slate-500 font-medium">Baseline Heat:</span>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="font-semibold text-slate-800">Telemetry Proof</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-slate-800">OSHA Audit</span>
          </button>
          ...
          >
            ...
            <span className="font-semibold text-slate-800">Direct Call</span>
          </button>
